...
- `.ai/skills/*` -> `~/.claude/skills/*`, `~/.codex/skills/*`, `~/.agents/skills/*`, `~/.cursor/skills/*`, `~/.gemini/config/skills/*` (one folder of plain SKILL.md directories shared by every agent, Antigravity included)
