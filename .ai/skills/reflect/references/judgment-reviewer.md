...
- `Read` tool calls against any `SKILL.md` file (workspace, user-level, or plugin-installed skill paths for any harness; see the Paths table in `../../rigorous-mode/references/harness.md`)
