...
At the end of the run, before handing back, check the log told the truth. Read this run's transcript from the active workspace's transcript directory (per `../rigorous-mode/references/harness.md`, whose transcript rules apply). Walk the log against what actually happened:
